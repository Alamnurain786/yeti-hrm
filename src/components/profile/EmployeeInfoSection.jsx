...
const EmployeeInfoSection = memo(
  ({ form, handleChange, managers = [], errors = {} }) => {
    return (
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        <div className="flex items-center mb-4 text-slate-800 font-semibold text-lg">
          <Users className="mr-2 text-blue-600" /> Employee Information /
          कर्मचारी जानकारी
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-3 py-2 rounded-xl border text-sm focus:ring-1 ${errors.manager ? "border-red-300 focus:border-red-500 focus:ring-red-500" : "border-slate-200 focus:border-blue-500 focus:ring-blue-500"}`}
              >
              ...
              {errors.manager && (
                <p className="text-xs text-red-600 mt-1">{errors.manager}</p>
              )}
            </div>
            <div>
              <label className="text-xs text-slate-600 font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <select
                ...
                className={`w-full px-3 py-2 rounded-xl border text-sm ${errors.religion ? "border-red-300 focus:border-red-500" : "border-slate-200 focus:border-blue-500"}`}
              >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 rounded-xl border text-sm ${errors.nationality ? "border-red-300 focus:border-red-500" : "border-slate-200 focus:border-blue-500"}`}
              />
              {errors.nationality && (
